...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/29 16:16:44 by anrivas-          #+#    #+#             */
/*   Updated: 2024/04/09 18:07:53 by anrivas-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	get_complex_map(int x, int y, t_fractol *fract)
{
	...
	i = 0;
	z.cmplx_r = (map((t_map_coords)
			{x, -2, +2, 0, WIDTH}) * fract->zoom) + fract->shift_r;
	z.cmplx_i = (map((t_map_coords)
